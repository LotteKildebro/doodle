...
<div class="cointainer zombie-mobile">
            <div class="row">
                ...
                <div class="col-sm-6 col-m-12 col-l-12 gameplay-text ">
                <h2>Enemies</h2>
        <p>You will encounter enemies along the way, the island is infested
        with dangerous zombies. Beware, if you walk into them they will bite and 
        you will lose life!
...
<div class="cointainer whitebg">
            <div class="row">
                ...
                <div class="col-sm-6 col-m-12 col-l-12 gameplay-text ">
                <h2>Objective</h2>
        <p>Your main goal is the pick up enough banans so that the gorilla king
             will fly you home, if you survive both levels he will wait for you at the end exit point.
        </p>
...
<div class="cointainer zombie-mobile">
        ...
        <p>The bananas is your collectables, you will need 10 bananas for the king to have 
            an interest in flying you home. If you try to buy
             is friendship with less than 10 bananas he won't help you at all and you lose the game.
        </p>
...
<div class="cointainer whitebg">
            <div class="row">
                <div class="col-sm-6 col-m-12 col-l-12 ">
                   <center> <img width="500px" src="images/survivor.png" alt="picture of game">  </center> 

                </div>
                <div class="col-sm-6 col-m-12 col-l-12 gameplay-text ">
                <h2>Save survivors</h2>
        <p>You can save survivors along the way, this is optional and won't effect the outcome of the 
            monkey kings choice to save you. This will only benefit the level of your moral compas.
        </p>
